<?php
/**
 * forms.php — Login page view (pure template).
 * Variables provided by AuthController: $loginError
 */
...
<head>
    ...
    <title>Connexion - Modern Bootstrap Admin</title>
                ...
                <div class="container-fluid p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="text-muted mb-0">Entrez vos informations pour vous connecter automatiquement</p>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php endif; ?>
                                    <form method="POST" action="/login" x-data="{ form: { firstName: '', lastName: '', email: '', subject: '', message: '' }, errors: {}, validateField(f) {}, getFieldClass(f) { return ''; } }">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" name="subject" x-model="form.subject" required>
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php endif; ?>
                                    <form method="POST" action="/login" x-data="{ form: { username: '', email: '', password: '', confirmPassword: '', agreeTerms: false }, errors: {}, showPassword: false, passwordStrength: { level: '', percentage: 0, color: 'muted', text: '' }, validateField(f) {}, validatePassword() {}, getFieldClass(f) { return ''; } }">
